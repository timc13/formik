...
var Field = (function (_super) {
    ...
    Field.prototype.componentWillMount = function () {
        ...
        warning_1$2(!(this.props.component && children && isFunction(children)), 'You should not use <Field component> and <Field children> as a function in the same <Field> component; <Field component> will be ignored.');
...
var FieldArray = (function (_super) {
    ...
    function FieldArray() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.changeValue = function (fn) {
            var _a = _this.context.formik, setFieldValue = _a.setFieldValue, values$$1 = _a.values;
    ...
    FieldArray.prototype.render = function () {
        ...
        var props = __assign({}, arrayHelpers, { form: this.context.formik });
        if (component) {
        ...
        return {
            formik: __assign({}, this.state, { dirty: dirty, isValid: dirty
                    ...
                    : this.props.isInitialValid !== false &&
                        ...
                        : this.props.isInitialValid, handleSubmit: this.handleSubmit, handleChange: this.handleChange, handleBlur: this.handleBlur, handleReset: this.handleReset, setStatus: this.setStatus, setTouched: this.setTouched, setErrors: this.setErrors, setError: this.setError, setValues: this.setValues, setFieldError: this.setFieldError, setFieldValue: this.setFieldValue, setFieldTouched: this.setFieldTouched, setSubmitting: this.setSubmitting, resetForm: this.resetForm, submitForm: this.submitForm, initialValues: this.initialValues, validateOnChange: this.props.validateOnChange, validateOnBlur: this.props.validateOnBlur }),
        };
    };
...
export { Formik, yupToFormErrors, validateYupSchema, touchAllFields, Field, Form, withFormik$$1 as withFormik, FieldArray };
